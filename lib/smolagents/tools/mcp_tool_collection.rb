module Smolagents
  ...
  # Re-export MCPToolCollection at the Smolagents level for backward compatibility.
  # @see Smolagents::Tools::MCPToolCollection
  MCPToolCollection = Tools::MCPToolCollection
end
