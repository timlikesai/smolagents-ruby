...
module Smolagents
  ...
  #
  # LocalRubyExecutor runs agent-generated Ruby code in a restricted sandbox
  ...
  #   executor = LocalRubyExecutor.new(trace_mode: :line)
  #
  #   # :call counts method calls only (faster, less accurate)
  #   executor = LocalRubyExecutor.new(trace_mode: :call)
  #
