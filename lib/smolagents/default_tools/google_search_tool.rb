...
module Smolagents
  module DefaultTools
    ...
    class GoogleSearchTool < Tool
      ...
      PROVIDERS = {
        "serpapi" => { url: "https://serpapi.com/search.json", key_env: "SERPAPI_API_KEY", results_key: "organic_results" },
        "serper" => { url: "https://google.serper.dev/search", key_env: "SERPER_API_KEY", results_key: "organic" }
      }.freeze
      ...
      def forward(query:, filter_year: nil)
        ...
        params.merge!("engine" => "google", "google_domain" => "google.com") if @provider == "serpapi"
