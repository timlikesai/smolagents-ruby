...
module Smolagents
  ...
  #   system = ChatMessage.system("You are a helpful assistant")
  #   user = ChatMessage.user("What is 2+2?")
  #   assistant = ChatMessage.assistant("The answer is 4")
  #
  # @example User message with images
  #   msg = ChatMessage.user("What's in this image?", images: ["photo.jpg"])
  #
  # @example Assistant message with tool calls
  #   msg = ChatMessage.assistant("Let me search for that",
