module Smolagents
  module Types
    ...
    CodeOutcome = Data.define(
      ...
      # @return [CodeOutcome] Outcome wrapping the result
      # @example
      #   result = ExecutionResult.success(output: "42", logs: "...")
      #   outcome = CodeOutcome.from_result(result, duration: 0.5)
